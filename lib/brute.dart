...
class Brute extends StatefulWidget {
  final int _deckSize;

  Brute(this._deckSize);

  @override
  _BruteState createState() => _BruteState(this._deckSize);
}

class _BruteState extends State<Brute> {
  final int _deckSize;
  int _turnsLeft = 0;
  int _restsLeft = 0;
  int _discarded = 0;
