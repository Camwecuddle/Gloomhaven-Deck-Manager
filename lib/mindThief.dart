...
class MindThief extends StatefulWidget {
  final int _deckSize;

  MindThief(this._deckSize);

  @override
  _MindThiefState createState() => _MindThiefState(this._deckSize);
}

class _MindThiefState extends State<MindThief> {
  final int _deckSize;
  int _turnsLeft = 0;
  int _restsLeft = 0;
  int _discarded = 0;
  ...
  _MindThiefState(this._deckSize);
