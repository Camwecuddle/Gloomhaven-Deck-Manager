...
class Tinkerer extends StatefulWidget {
  final int _deckSize;

  Tinkerer(this._deckSize);

  @override
  _TinkererState createState() => _TinkererState(this._deckSize);
}

class _TinkererState extends State<Tinkerer> {
  final int _deckSize;
  int _turnsLeft = 0;
  int _restsLeft = 0;
  int _discarded = 0;
